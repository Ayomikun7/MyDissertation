...
joined_df_cln <-
  ...
  mutate(
    ...
    race_category = case_when(
      str_detect(race_category, fixed("white", ignore_case = TRUE)) ~ "white",
      str_detect(race_category, fixed("black", ignore_case = TRUE)) ~ "black",
      is.na(race_category) ~ NA_character_,
      TRUE ~ "other_minority_ethnic"
      # 
    )
